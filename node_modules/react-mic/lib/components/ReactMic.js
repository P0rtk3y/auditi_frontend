  ...
  function ReactMic(props) {
    ...
    _this.visualize = function () {
      ...
      if (visualSetting === 'sinewave') {
        _Visualizer2.default.visualizeSineWave(canvasCtx, canvas, width, height, backgroundColor, strokeColor);
      } else if (visualSetting === 'frequencyBars') {
        _Visualizer2.default.visualizeFrequencyBars(canvasCtx, canvas, width, height, backgroundColor, strokeColor);
      } else if (visualSetting === 'frequencyCircles') {
        _Visualizer2.default.visualizeFrequencyCircles(canvasCtx, canvas, width, height, backgroundColor, strokeColor);
      }
    };
